...
# Utilisation De L’IA
On a utilisé l’IA ponctuellement pour reformuler des idées, clarifier la rédaction et débloquer quelques points techniques. Ça nous a aussi aidés à résumer certaines documentations (OpenCV, MoviePy) et à nous assister sur la dernière semaine avant le rendu, car nous étions en période d’examens (bac blanc). Toute la logique de programmation a été faite par nous‑mêmes, et chaque changement a été relu, testé et corrigé par nous‑mêmes.
